...
<<<<<<< HEAD
tree = ET.parse(r'C:\users\lenovo\MoMo-Data-Analysis\modified_sms_v2.xml')
=======
tree = ET.parse(r'C:\Users\Seyi Adebayo\Searches\MoMo-Data-Analysis\modified_sms_v2.xml')
>>>>>>> 848689a2f086fd7f268b1391f3d463aa4806ed68
root = tree.getroot()
...
tree = ET.parse(r'/mnt/d/ALU/Software_Engineering/PROJECTS/MoMo-Data-Analysis/modified_sms_v2.xml')
root = tree.getroot()
...
write_to_file('Data_Categorization/reversed.xml', reversed)
write_to_file('Data_Categorization/Failed.xml', Failed)
>>>>>>> 339ed7215c817c8d2797c9402daf307d81ad94d3
